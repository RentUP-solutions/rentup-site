...
(function () {
  ...
  var T = {
    ...
    /* 03 — Pachete & Prețuri */
    'Raport de Rentabilitate (Gratuit)': 'Profitability Report (Free)',
    '— design pur: plan de amenajare, moodboard, buget mobilier cu furnizori, 1 vizită pe șantier. Fără Rental Kit, fără selecție chiriaș. Bun dacă vrei să te muți din apartament și vrei să îl închiriezi cu minimum de implicare în sistem.': '— pure design: layout plan, moodboard, furniture budget with suppliers, 1 site visit. No Rental Kit, no tenant selection. Good if you want to move out of the apartment and rent it with minimum system involvement.',
    ...
    'Depinde de pachet: Quick Win 1–2 săptămâni (fără lucrări, doar mobilier și sistem); Design pentru chirie 2–3 săptămâni; Invest Standard 4–6 săptămâni; Invest Premium 8–12 săptămâni.': 'Depends on the package: Quick Win 1–2 weeks (no works, just furniture and system); Design for rental 2–3 weeks; Invest Standard 4–6 weeks; Invest Premium 8–12 weeks.',
    ...
    /* 07 — Rental Kit */
    'Da. Pachetul Design pentru chirie include exact asta: plan de amenajare, moodboard per cameră, buget mobilier cu furnizori și o vizită pe șantier. Fără selecție chiriaș, fără contract personalizat, fără listare.': 'Yes. The Design for rental package includes exactly that: layout plan, moodboard per room, furniture budget with suppliers and one site visit. No tenant selection, no personalised contract, no listing.',
